...
export default function Ornements() {
  return (
    <div className="w-screen absolute z-40">
      ...
      <div className="flex w-full">
        ...
        <div className="w-full z-40 fixed bottom-5 items-center text-center justify-center">
          <h1 className="font-lune text-lune text-2xl md:text-3xl lg:text-4xl uppercase">
            La lune curieuse
          </h1>
        </div>
