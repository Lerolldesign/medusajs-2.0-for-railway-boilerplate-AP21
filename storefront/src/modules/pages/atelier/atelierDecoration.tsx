      ...
      <div className="flex flex-col xl:flex-row mx-10  md:mx-32 xl:mx-32 relative top-[0vh] md:top-10 xl:top-32">
        ...
        <div className="w-full xl:w-1/3 flex flex-col md:items-center md:justify-center">
          ...
          >
            ...
            nouvelles techniques pour satisfaire vos demandes et suis toujours
            prête à apprendre et à me former pour rester à la pointe des
            tendances et donner vie à vos projets. Ma clientèle est variée,
            allant des professionnels (boutiques, restaurants, hôtels,
            décorateurs d’intérieurs) aux particuliers en quête d’une
            réalisation originale pour leur intérieur.
          </p>
          <h3 className="text-lune font-lune text-[2rem] leading-[2.5rem] xl:text-[3rem] 2xl:leading-[3.5rem] 2xl:text-[4rem] xl:leading-[4.5rem] py-20 relative md:text-center w-[40vh] xl:w-[60vw] 2xl:w-[50vw]">
            Alors n’hésitez pas à pousser la porte de mon atelier, je vous
